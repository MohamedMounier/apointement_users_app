...
class AppointmentsRepositoryImpl implements AppointmentsRepository {
  ...
  @override
  Future<ResponseWrapper<List<AppointmentEntity>>> getAppointmentsForSpecialist(String specialistId) async {
    final response = await _dataSource.fetchAppointmentsForSpecialist(specialistId: specialistId);

    return response.when(
      success: (models) => ResponseWrapper.success(
  ...
  @override
  Future<ResponseWrapper<void>> bookAppointment(AppointmentEntity appointment) async{
    final model = AppointmentModel(
      ...
      rescheduleRequestedDate: appointment.rescheduleRequestedDate != null
